<%-- 
    Document   : descrizion
    Created on : 25-apr-2017, 13.28.31
    Author     : Asus
--%>
...
<html>
    ...
    <body>
        ...
        <div id="sommario">
            <ul>
                <li><a href="descrizione.html#intro">NerdBook: Che cos'è NerdBook?</a></li>
                <li><ul>
